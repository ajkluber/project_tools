...
def get_args():
    ...
    add_parser.add_argument('--temparray', type=int, nargs='+', help='T_initial T_final dT for new temps')
    add_parser.add_argument('--mutarray', type=float, nargs='+', help='List of temps for new equilibrium simulations')
